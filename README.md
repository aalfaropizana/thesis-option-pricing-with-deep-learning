...
This project builds upon the excellent foundational work by Paolo D'Elia.

## About the Maintainer

Ana Pizana is an AI & LLM Engineer with over 4 years of professional experience, specializing in Python, Deep Learning frameworks like PyTorch and TensorFlow, and data science libraries such as NumPy and Pandas. She actively maintains and enhances this project.

You can connect with Ana:
